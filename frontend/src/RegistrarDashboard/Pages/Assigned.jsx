...
const Dashboard = () => {
  ...
  const issues = [
    { type: 'Missing marks', regNo: '2024/BSCS/3210', name: 'KALA SAMUEL', lecturer: 'Dr. John Doe', courseCode: 'CS101', status: 'Pending', date: 'Feb 14, 2025, 10:30am' },
    { type: 'Exam results', regNo: '2024/BSCS/3211', name: 'AHURIRA GRACE', lecturer: 'Dr. Jane Smith', courseCode: 'CS202', status: 'In Progress', date: 'Feb 14, 2025, 10:30am' },
    ...
    <div style={{ padding: '20px' }}>
      ...
      {selectedIssue && (
        <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'white', padding: '20px', boxShadow: '0px 0px 10px gray' }}>
          ...
          <p><strong>Date Assigned:</strong> {selectedIssue.date}</p>
